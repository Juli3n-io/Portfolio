...
publication d'un avis directement depuis le tableau de posts.php en Ajax
...
if (!empty($_POST)) {
  ...
  if ($publie == 0) {
    ...
    $req = $pdo->prepare('UPDATE reviews SET est_publie = :publie WHERE id = :id');
    ...
    $result['status'] = true;
    $result['notif'] = notif('success', 'Reviews publié');
    ...
    $result['status'] = true;
    $result['notif'] = notif('success', 'Reviews retiré');
