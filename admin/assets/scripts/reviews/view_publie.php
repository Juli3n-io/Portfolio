...
$query = $pdo->query("SELECT * FROM reviews WHERE est_publie = 1 ORDER BY date_enregistrement ASC LIMIT $start_from,$record_per_page");
...
$page_query = $pdo->query('SELECT * FROM reviews WHERE est_publie = 1 ORDER BY date_enregistrement ASC ');
